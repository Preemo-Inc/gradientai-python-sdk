...
from gradientai.openapi.client.models.extract_pdf_success import ExtractPdfSuccess  # noqa: E501
from gradientai.openapi.client.rest import ApiException

class TestExtractPdfSuccess(unittest.TestCase):
    """ExtractPdfSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ExtractPdfSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtractPdfSuccess`
        """
        model = gradientai.openapi.client.models.extract_pdf_success.ExtractPdfSuccess()  # noqa: E501
        if include_optional :
            return ExtractPdfSuccess(
                pages = [
                    gradientai.openapi.client.models.extract_pdf_success_pages_inner.ExtractPdfSuccess_pages_inner(
                        images = [
    ...
    def testExtractPdfSuccess(self):
        """Test ExtractPdfSuccess"""
