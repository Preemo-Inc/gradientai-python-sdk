...
class GetAudioTranscriptionError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAudioTranscriptionError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAudioTranscriptionError:
        """Create an instance of GetAudioTranscriptionError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAudioTranscriptionError.parse_obj(obj)

        _obj = GetAudioTranscriptionError.parse_obj({
