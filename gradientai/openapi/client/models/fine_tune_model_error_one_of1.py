...
class FineTuneModelErrorOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FineTuneModelErrorOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FineTuneModelErrorOneOf1:
        """Create an instance of FineTuneModelErrorOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FineTuneModelErrorOneOf1.parse_obj(obj)

        _obj = FineTuneModelErrorOneOf1.parse_obj({
