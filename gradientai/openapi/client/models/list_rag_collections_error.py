...
class ListRagCollectionsError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRagCollectionsError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRagCollectionsError:
        """Create an instance of ListRagCollectionsError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListRagCollectionsError.parse_obj(obj)

        _obj = ListRagCollectionsError.parse_obj({
