...
class CreateModelBodyParamsInitialHyperparametersLoraHyperparameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModelBodyParamsInitialHyperparametersLoraHyperparameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModelBodyParamsInitialHyperparametersLoraHyperparameters:
        """Create an instance of CreateModelBodyParamsInitialHyperparametersLoraHyperparameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModelBodyParamsInitialHyperparametersLoraHyperparameters.parse_obj(obj)

        _obj = CreateModelBodyParamsInitialHyperparametersLoraHyperparameters.parse_obj({
            "rank": obj.get("rank")
        })
