...
class ListEmbeddingsError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListEmbeddingsError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListEmbeddingsError:
        """Create an instance of ListEmbeddingsError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListEmbeddingsError.parse_obj(obj)

        _obj = ListEmbeddingsError.parse_obj({
