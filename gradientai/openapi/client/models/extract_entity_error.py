...
class ExtractEntityError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtractEntityError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtractEntityError:
        """Create an instance of ExtractEntityError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtractEntityError.parse_obj(obj)

        _obj = ExtractEntityError.parse_obj({
