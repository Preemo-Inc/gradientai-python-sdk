...
class ExtractPdfError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtractPdfError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtractPdfError:
        """Create an instance of ExtractPdfError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtractPdfError.parse_obj(obj)

        _obj = ExtractPdfError.parse_obj({
