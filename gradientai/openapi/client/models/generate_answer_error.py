...
class GenerateAnswerError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateAnswerError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateAnswerError:
        """Create an instance of GenerateAnswerError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateAnswerError.parse_obj(obj)

        _obj = GenerateAnswerError.parse_obj({
