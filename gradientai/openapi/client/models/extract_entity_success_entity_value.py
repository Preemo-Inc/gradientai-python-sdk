...
class ExtractEntitySuccessEntityValue(BaseModel):
    """
    ExtractEntitySuccessEntityValue
    """
    ...
    actual_instance: Any
    any_of_schemas: List[str] = Field(EXTRACTENTITYSUCCESSENTITYVALUE_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ExtractEntitySuccessEntityValue.construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ExtractEntitySuccessEntityValue with anyOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> ExtractEntitySuccessEntityValue:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ExtractEntitySuccessEntityValue:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ExtractEntitySuccessEntityValue with anyOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
