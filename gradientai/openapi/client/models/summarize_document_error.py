...
class SummarizeDocumentError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SummarizeDocumentError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SummarizeDocumentError:
        """Create an instance of SummarizeDocumentError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SummarizeDocumentError.parse_obj(obj)

        _obj = SummarizeDocumentError.parse_obj({
