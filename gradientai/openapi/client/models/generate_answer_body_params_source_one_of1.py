...
class GenerateAnswerBodyParamsSourceOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateAnswerBodyParamsSourceOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateAnswerBodyParamsSourceOneOf1:
        """Create an instance of GenerateAnswerBodyParamsSourceOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateAnswerBodyParamsSourceOneOf1.parse_obj(obj)

        _obj = GenerateAnswerBodyParamsSourceOneOf1.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value")
        })
