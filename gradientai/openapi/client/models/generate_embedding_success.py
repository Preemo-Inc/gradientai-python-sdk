...
class GenerateEmbeddingSuccess(BaseModel):
    ...
    """
    embeddings: conlist(GenerateEmbeddingSuccessEmbeddingsInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateEmbeddingSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateEmbeddingSuccess:
        """Create an instance of GenerateEmbeddingSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateEmbeddingSuccess.parse_obj(obj)

        _obj = GenerateEmbeddingSuccess.parse_obj({
            "embeddings": [GenerateEmbeddingSuccessEmbeddingsInner.from_dict(_item) for _item in obj.get("embeddings")] if obj.get("embeddings") is not None else None
        })
