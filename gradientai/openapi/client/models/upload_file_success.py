...
class UploadFileSuccess(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadFileSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadFileSuccess:
        """Create an instance of UploadFileSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UploadFileSuccess.parse_obj(obj)

        _obj = UploadFileSuccess.parse_obj({
            "id": obj.get("id")
        })
