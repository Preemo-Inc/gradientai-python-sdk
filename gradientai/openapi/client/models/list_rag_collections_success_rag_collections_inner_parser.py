...
class ListRagCollectionsSuccessRagCollectionsInnerParser(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ListRagCollectionsSuccessRagCollectionsInnerParser.construct()
        error_messages = []
        match = 0
        # validate data type: ListRagCollectionsSuccessRagCollectionsInnerParserOneOf
        if not isinstance(v, ListRagCollectionsSuccessRagCollectionsInnerParserOneOf):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRagCollectionsSuccessRagCollectionsInnerParser:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ListRagCollectionsSuccessRagCollectionsInnerParser:
        """Returns the object represented by the json string"""
        instance = ListRagCollectionsSuccessRagCollectionsInnerParser.construct()
        error_messages = []
        match = 0

        # deserialize data into ListRagCollectionsSuccessRagCollectionsInnerParserOneOf
        try:
            instance.actual_instance = ListRagCollectionsSuccessRagCollectionsInnerParserOneOf.from_json(json_str)
            match += 1
