...
class CreateRagCollectionError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRagCollectionError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRagCollectionError:
        """Create an instance of CreateRagCollectionError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRagCollectionError.parse_obj(obj)

        _obj = CreateRagCollectionError.parse_obj({
