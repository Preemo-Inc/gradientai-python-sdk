...
class DeleteRagCollectionError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteRagCollectionError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteRagCollectionError:
        """Create an instance of DeleteRagCollectionError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteRagCollectionError.parse_obj(obj)

        _obj = DeleteRagCollectionError.parse_obj({
