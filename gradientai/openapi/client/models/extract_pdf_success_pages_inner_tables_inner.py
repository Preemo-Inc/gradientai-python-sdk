...
class ExtractPdfSuccessPagesInnerTablesInner(BaseModel):
    """
    ExtractPdfSuccessPagesInnerTablesInner
    """
    name: StrictStr = Field(...)
    table_rows: conlist(ExtractPdfSuccessPagesInnerTablesInnerTableRowsInner) = Field(..., alias="tableRows")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtractPdfSuccessPagesInnerTablesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtractPdfSuccessPagesInnerTablesInner:
        """Create an instance of ExtractPdfSuccessPagesInnerTablesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtractPdfSuccessPagesInnerTablesInner.parse_obj(obj)

        _obj = ExtractPdfSuccessPagesInnerTablesInner.parse_obj({
            "name": obj.get("name"),
            "table_rows": [ExtractPdfSuccessPagesInnerTablesInnerTableRowsInner.from_dict(_item) for _item in obj.get("tableRows")] if obj.get("tableRows") is not None else None
        })
