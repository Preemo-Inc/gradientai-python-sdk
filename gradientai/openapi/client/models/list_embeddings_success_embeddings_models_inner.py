...
class ListEmbeddingsSuccessEmbeddingsModelsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListEmbeddingsSuccessEmbeddingsModelsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListEmbeddingsSuccessEmbeddingsModelsInner:
        """Create an instance of ListEmbeddingsSuccessEmbeddingsModelsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListEmbeddingsSuccessEmbeddingsModelsInner.parse_obj(obj)

        _obj = ListEmbeddingsSuccessEmbeddingsModelsInner.parse_obj({
            "slug": obj.get("slug")
        })
