...
class CreateRagCollectionBodyParamsFilesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRagCollectionBodyParamsFilesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRagCollectionBodyParamsFilesInner:
        """Create an instance of CreateRagCollectionBodyParamsFilesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRagCollectionBodyParamsFilesInner.parse_obj(obj)

        _obj = CreateRagCollectionBodyParamsFilesInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
