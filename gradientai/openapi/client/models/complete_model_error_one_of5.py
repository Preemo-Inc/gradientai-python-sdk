...
class CompleteModelErrorOneOf5(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteModelErrorOneOf5:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteModelErrorOneOf5:
        """Create an instance of CompleteModelErrorOneOf5 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteModelErrorOneOf5.parse_obj(obj)

        _obj = CompleteModelErrorOneOf5.parse_obj({
