...
class CompleteModelErrorOneOf10(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteModelErrorOneOf10:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteModelErrorOneOf10:
        """Create an instance of CompleteModelErrorOneOf10 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteModelErrorOneOf10.parse_obj(obj)

        _obj = CompleteModelErrorOneOf10.parse_obj({
