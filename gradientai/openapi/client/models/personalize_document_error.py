...
class PersonalizeDocumentError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonalizeDocumentError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonalizeDocumentError:
        """Create an instance of PersonalizeDocumentError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonalizeDocumentError.parse_obj(obj)

        _obj = PersonalizeDocumentError.parse_obj({
