...
class CreateRagCollectionSuccess(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRagCollectionSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRagCollectionSuccess:
        """Create an instance of CreateRagCollectionSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRagCollectionSuccess.parse_obj(obj)

        _obj = CreateRagCollectionSuccess.parse_obj({
            "id": obj.get("id")
        })
