...
class CreateAudioTranscriptionError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAudioTranscriptionError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAudioTranscriptionError:
        """Create an instance of CreateAudioTranscriptionError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAudioTranscriptionError.parse_obj(obj)

        _obj = CreateAudioTranscriptionError.parse_obj({
