...
class UploadFileError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadFileError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadFileError:
        """Create an instance of UploadFileError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UploadFileError.parse_obj(obj)

        _obj = UploadFileError.parse_obj({
