...
class FineTuneModelBodyParams(BaseModel):
    ...
    """
    samples: conlist(FineTuneModelBodyParamsSamplesInner) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FineTuneModelBodyParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FineTuneModelBodyParams:
        """Create an instance of FineTuneModelBodyParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FineTuneModelBodyParams.parse_obj(obj)

        _obj = FineTuneModelBodyParams.parse_obj({
            "samples": [FineTuneModelBodyParamsSamplesInner.from_dict(_item) for _item in obj.get("samples")] if obj.get("samples") is not None else None
        })
