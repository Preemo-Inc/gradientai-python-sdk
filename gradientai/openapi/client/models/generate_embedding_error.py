...
class GenerateEmbeddingError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GenerateEmbeddingError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GenerateEmbeddingError:
        """Create an instance of GenerateEmbeddingError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GenerateEmbeddingError.parse_obj(obj)

        _obj = GenerateEmbeddingError.parse_obj({
