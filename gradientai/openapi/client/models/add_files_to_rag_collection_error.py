...
class AddFilesToRagCollectionError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddFilesToRagCollectionError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddFilesToRagCollectionError:
        """Create an instance of AddFilesToRagCollectionError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddFilesToRagCollectionError.parse_obj(obj)

        _obj = AddFilesToRagCollectionError.parse_obj({
