...
class AnalyzeSentimentError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnalyzeSentimentError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnalyzeSentimentError:
        """Create an instance of AnalyzeSentimentError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnalyzeSentimentError.parse_obj(obj)

        _obj = AnalyzeSentimentError.parse_obj({
