...
class CompleteModelErrorOneOf8(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteModelErrorOneOf8:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteModelErrorOneOf8:
        """Create an instance of CompleteModelErrorOneOf8 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteModelErrorOneOf8.parse_obj(obj)

        _obj = CompleteModelErrorOneOf8.parse_obj({
